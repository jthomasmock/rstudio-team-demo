...
```{r}
pins::pin_write(beaver1, name = "thomas/beaverData", description = "Beaver Body Temperature Measurements", board = "rsconnect")
```
...
# Retrieve Pin
pinned_beaver_data <- pin_read("thomas/beaverData", board = "rsconnect")
  
# View the pin locally
head(pinned_beaver_data)
```
