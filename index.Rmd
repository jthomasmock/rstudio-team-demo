...
meta() %>%
  ...
  meta_social(
    ...
    url = "https://colorado.rstudio.com/rsc/plumbertableau-prez",
...
background-image: url("images/sds-1.png")
background-position: center
background-size: contain

---

background-image: url("images/sds-2.png")
background-position: center
background-size: contain

---

background-image: url("images/sds-3.png")
background-position: center
background-size: contain

---

background-image: url("images/sds-4.png")
background-position: center
background-size: contain

---

background-image: url("images/sds-5.png")
background-position: center
background-size: contain

<!-- --- -->

<!-- background-image: url("images/sds-6.png") -->
<!-- background-position: center -->
<!-- background-size: contain -->

---

background-image: url("images/sds-7.png")
background-position: center
background-size: contain

---

background-image: url("images/sds-8.png")
background-position: center
background-size: contain

---

background-image: url("images/sds-9.png")
background-position: center
background-size: contain

---

background-image: url("images/sds-10.png")
background-position: center
background-size: contain
...
background-image: url("images/rstudio-1.png")
background-position: center
background-size: contain

---

background-image: url("images/rstudio-2.png")
background-position: center
background-size: contain

---

background-image: url("images/rstudio-3.png")
background-position: center
background-size: contain

---

background-image: url("images/rstudio-4.png")
background-position: center
background-size: contain

---

background-image: url("images/rstudio-5.png")
background-position: center
background-size: contain

---

background-image: url("images/rstudio-6.png")
background-position: center
background-size: contain

---

background-image: url("images/rstudio-7.png")
background-position: center
background-size: contain
...
<span style = 'font-style: italic; font-size:150%;'>Create free and open-source software for data science, scientific research, and technical communication</span>
